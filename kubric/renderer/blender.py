            ...
            if obj.use_parenting_instead_of_join:
              ...
              if non_mesh_objects:
                if bpy.app.version >= (3, 2, 0):
                    ...
                    # Versions below Blender 3.2 use the legacy method.
                    # Deselect all objects first.
                    bpy.ops.object.select_all(action='DESELECT')
                    # Select non-mesh objects to delete.
                    for obj in non_mesh_objects:
                        obj.select_set(True)
                    # Delete the selected objects.
                    bpy.ops.object.delete()
                    # Re-select mesh objects.
                    for obj in bpy.context.scene.objects:
                        if obj.type == "MESH":
                            obj.select_set(True)
...
class AttributeSetter:
  """TODO: provide a high-level description of the observer implementation."""
